...
@extends('layouts.app')
@section('title', 'Library Musik – Namárië')
...
<div class="page-header-sticky">
  <div style="display:flex;justify-content:space-between;align-items:center;gap:12px">
    <div class="page-title" style="margin-bottom:0;flex-shrink:0" id="main-page-title">Music Library</div>
...
<div class="card">
  ...
  @else
    <div class="section-header">
      <span class="section-title">{{ $music->count() }} songs</span>
    </div>
      ...
      <div class="music-row"
        ...
        <div class="music-info-click" style="display:flex;align-items:center;flex:1;gap:10px;cursor:pointer">
          ...
          <div class="music-info">
            ...
            <div class="music-meta">{{ $track->duration_formatted }}</div>
          </div>
        </div>

        {{-- Like --}}
        <button class="music-like" data-id="{{ $track->id }}" title="Suka"
        ...
        <button class="add-to-pl-btn" data-idx="{{ $i }}" data-id="{{ $track->id }}" title="Tambah ke playlist"
        ...
        <div class="music-actions" onclick="event.stopPropagation()">
          ...
          <button class="icon-btn" title="Rename" onclick="startRename({{ $track->id }})">
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
